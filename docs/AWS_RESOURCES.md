...
| **Amazon ECR Repository** | `clauserunner-web` | `us-east-1` | Stores the unified ClauseRunner container image (Docker) for cloud-native deployment. | **Yes** (For container builds) |
